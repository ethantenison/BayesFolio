...
Run directory: `/Users/et/Documents/BayesFolio/experiments/2026-06-portfolio-optimization/outputs/runs/20260616_component_outputscale_floor_portfolio`
...
| ---------------------------- | ------------ | ----------------- | ------ | -------------- | ------ | ------------ | -------------- | ------------------- | -------- | ------------ | ---------- | ------- | --------- |
| gp_scenarios_riskfolio       | 12.0000      | 0.1562            | 0.1562 | 0.0936         | 1.6694 | -0.0580      | 11562.0603     | 0.0125              | 0.8333   | 0.2135       | 0.1893     | 0.1441  | 0.1721    |
...
- `gp_scenarios_riskfolio` experiment variant: `component_outputscale_floor`. Control is positive beta task covariance, lengthscale-only time modulation, rank 5.
