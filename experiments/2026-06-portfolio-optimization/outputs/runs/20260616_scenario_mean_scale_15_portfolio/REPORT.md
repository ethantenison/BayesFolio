...
Run directory: `/Users/et/Documents/BayesFolio/experiments/2026-06-portfolio-optimization/outputs/runs/20260616_scenario_mean_scale_15_portfolio`
...
| ---------------------------- | ------------ | ----------------- | ------ | -------------- | ------ | ------------ | -------------- | ------------------- | -------- | ------------ | ---------- | ------- | --------- |
| gp_scenarios_riskfolio       | 12.0000      | 0.1906            | 0.1906 | 0.0971         | 1.9630 | -0.0555      | 11906.2789     | 0.0150              | 0.8333   | 0.2295       | 0.1890     | 0.3708  | 0.3941    |
...
- `gp_scenarios_riskfolio` experiment variant: `scenario_mean_scale`. Control is positive beta task covariance, lengthscale-only time modulation, rank 5.
