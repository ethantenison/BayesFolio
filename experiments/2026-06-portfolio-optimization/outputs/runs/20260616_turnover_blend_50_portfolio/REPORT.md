...
Run directory: `/Users/et/Documents/BayesFolio/experiments/2026-06-portfolio-optimization/outputs/runs/20260616_turnover_blend_50_portfolio`
...
| ---------------------------- | ------------ | ----------------- | ------ | -------------- | ------ | ------------ | -------------- | ------------------- | -------- | ------------ | ---------- | ------- | --------- |
| gp_scenarios_riskfolio       | 12.0000      | 0.1892            | 0.1892 | 0.0954         | 1.9820 | -0.0545      | 11891.8013     | 0.0149              | 0.8333   | 0.1536       | 0.1884     | 0.3708  | 0.3941    |
...
- `gp_scenarios_riskfolio` experiment variant: `turnover_blend`. Control is positive beta task covariance, lengthscale-only time modulation, rank 5.
