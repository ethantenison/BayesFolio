...
TIME_KERNEL_GRID = {
   ...
   #KernelType.PERIODIC_MATERN: [0.5, 1.5, 2.5],   # Matern 5/2 + periodic kinda good for SPY, IJR, MGK, VTV
}
...
mlflow.set_experiment("What kernel strucuture will lead to the best portfolio returns?")
